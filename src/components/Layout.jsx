...
const navLinkClass = ({ isActive }) =>
  `${brutalistBox} ${brutalistHover} font-black uppercase tracking-wider px-6 py-3 flex items-center gap-2 cursor-pointer ${
    isActive
      ...
      : 'bg-[#F5F1DF] dark:bg-[#262626] dark:text-[#F5F1DF]'
  }`
...
const Layout = () => {
  ...
  return (
    <div className={`${isDark ? 'dark' : ''} min-h-screen bg-[#F5F1DF] dark:bg-[#181818] text-[#181818] dark:text-[#F5F1DF] font-sans selection:bg-[#DBA538] selection:text-[#181818] flex flex-col`}>
      {/* Fake browser header */}
      <div className="bg-[#F5F1DF] dark:bg-[#1A1A1A] border-b-4 border-[#181818] dark:border-[#F5F1DF] flex items-center px-4 py-2 sticky top-0 z-50">
        <div className="flex gap-2 mr-6">
          <div className="w-4 h-4 rounded-full bg-[#D93635] border-2 border-[#181818] dark:border-[#F5F1DF]" />
          <div className="w-4 h-4 rounded-full bg-[#DBA538] border-2 border-[#181818] dark:border-[#F5F1DF]" />
          <div className="w-4 h-4 rounded-full bg-[#A81C24] border-2 border-[#181818] dark:border-[#F5F1DF]" />
        </div>
        <div className="flex-1 bg-white dark:bg-[#262626] border-4 border-[#181818] dark:border-[#F5F1DF] h-8 flex items-center px-4 mx-4">
          <span className="font-bold text-sm dark:text-[#F5F1DF]">https://aliciamaia.qa</span>
        </div>
        <button
          onClick={toggleTheme}
          aria-label={isDark ? 'Ativar modo claro' : 'Ativar modo escuro'}
          className="ml-4 p-2 border-4 border-[#181818] dark:border-[#F5F1DF] bg-[#F5F1DF] dark:bg-[#262626] hover:bg-[#DBA538] dark:hover:bg-[#DBA538] transition-colors cursor-pointer"
        >
          {isDark
