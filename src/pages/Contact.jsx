...
const Contact = () => (
  <footer className="max-w-6xl mx-auto px-6 py-16 border-t-8 border-[#181818] dark:border-[#050505] flex flex-col md:flex-row justify-between items-center gap-8">
    <div>
